...
const std::string input_layer_name = "YCbCrA_IRI_UNET_relu_activation-in_YCbCr_layer";//"input";
const std::string output_layer_name = "YCbCrA_IRI_UNET_relu_activation-c";//"softmax1";
